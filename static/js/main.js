...
$("#submit").on("click", e => {
    e.preventDefault();
    const novoAssunto = new Assunto($("#nome").val(), $("#descricao").val(), $("#nivelDominio").val(), $("#contexto").val(), $("#nivelComplexidade").val(), !!$("jaConheciaAntes").val());
